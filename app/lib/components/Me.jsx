			...
			>
				<If condition={connected}>
					<div className='controls'>
						...
						>
							{micState==='on'?<FaMicrophone className='icon' />:<FaMicrophoneSlash className='icon' />}
						</div>
						...
						>
							{webcamState==='on'?<FaVideo className='icon' />:<FaVideoSlash className='icon' />}
						</div>
						...
						>
							{changeWebcamState==='on' && <FcRotateCamera className='icon' />}
						</div>
						<div
						...
						>
							{shareState==='on'?<MdStopScreenShare className='icon' />:<MdScreenShare className='icon' />}
						</div>
					</div>
				</If>
